...
<html>
  ...
  <body>
  	...
  	<div id="left">
  		<ul>
  			<li  style="cursor:hand;cursor:pointer" onclick="showUser();">查看教师信息</li>
  			<li  style="cursor:hand;cursor:pointer" onclick="showUpdateUser();">修改教师信息</li>
  			<li style="cursor:hand;cursor:pointer" onclick="showAddUser();">添加教师信息</li>
    ...
    <div id="right">
               ...
               <div id="daohang">
                      ...
                      <a href="${teacherManage}" id="checked">教师管理</a>
	               		...
	               		<s:iterator value="listUser" var="i">
	               		  <tr>
	               			...
	               			<td>
	               				...
	               				<s:url action="account_delTeacher" var="del"/>
               ...
               <div id="updateUsers" class="content">
                ...
                <div id="addUser" class="content">
               		...
               		<input type="button"  value="添加教师" id="btnAdd" onclick="addTeacher();"/>
               </div>
    </div>
    <div id="buttom"></div>
    </div> 
